...
if __name__ == "__main__":
    ...
    manager.add_ex_webscoket(BitoExWebsocket(StreamType.Trade, "wss://stream.bitopro.com:443/ws/v1/pub/trades/", config.subscribe_symbols))
    manager.add_ex_webscoket(BitoExWebsocket(StreamType.Quote, "wss://stream.bitopro.com:443/ws/v1/pub/order-books?pairs=", config.subscribe_symbols))
